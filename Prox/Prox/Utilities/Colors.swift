...
extension Colors {
    ...
    public static let carouselViewSunriseSetTimesLabelText = UIColor(colorLiteralRed: 0.0, green: 0.0, blue: 0.0, alpha: 0.5)
    public static let carouselViewImageOpacityLayer = UIColor(colorLiteralRed: 0.0, green: 0.0, blue: 0.0, alpha: 0.2)
...
extension Colors {
    ...
    public static let pageIndicatorTintColor = UIColor(colorLiteralRed: 0, green: 0, blue: 0, alpha: 0.5)
